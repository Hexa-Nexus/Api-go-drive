...
class GestorController {
    ...
    static async criandoGestor(req, res) {
        ...
        try {
            ...
            return res
                .status(500).json({ error: "Erro ao criar o gestor!", details: error.message });
        }
    }
    ...
    static async buscarGestores(req, res) {
        try {
            ...
            return res.status(500).json({ error: 'Erro ao buscar os gestores! ', details: error.message })
        }
    }
    ...
    static async buscarGestorId(req, res) {
        ...
        try {
            ...
            return res.status(500).json({ error: 'Erro ao buscar Gestor! ', details: error.message })
        }
    ...
    static async editarGestor(req, res) {
        ...
        try {
            ...
            if (cpf && cpf !== gestorExistente.cpf) {
                ...
                if (cpfEmUso) {
                    return res.status(400).json({ error: 'CPF já está em uso por outro gestor!' });
                }
            }
            ...
            if (email && email !== gestorExistente.email) {
                ...
                if (emailJaUsado) {
                    return res.status(400).json({ error: 'E-mail já está em uso por outro gestor!' });
                }
            }
            ...
            return res.status(400).json({ error: 'Erro ao editar gestor', details: error.message });
        }
    }
    ...
    static async deletarGestor(req, res) {
        ...
        try {
            ...
            return res.status(500).json({ error: 'Erro ao deletar Gestor', details: error.message });
        };
    };
